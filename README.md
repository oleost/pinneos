...
#   release/pinneos-0.1.0-x86_64.img.zst — A/B USB image for Etcher
```

**Write to USB:**

- **Windows / macOS:** Open [BalenaEtcher](https://etcher.balena.io), select `pinneos-*.img.zst`, write to USB. Done.
- **Rufus:** Select `pinneos-*.img.zst` → **DD Image mode** → write.
...
- **v0.1.0** — Initial release
  - Full A/B USB build pipeline (Etcher-ready `.img.zst`)
